...
| -- | -- | -- | -- | -- | -- | -- |
| Q.MS1.001.[j] | <a id="S" href="#S"></a>Gradient echo model <button class="md-button" onclick="copyToClip(document.getElementById('S').href)">COPY HYPERLINK</button> | -- | *S<sub>j</sub>* | The MR signal (magnitude, phase or complex depending on context) in compartment *j*. | a.u. | -- |
