...
| Q.US1.005 | <a name="Median"></a> Median value (sample) | -- | *x<sub>median</sub>* | Centermost point <img src="https://latex.codecogs.com/svg.image?x_{\frac{n&plus;1}{2}}" title="https://latex.codecogs.com/svg.image?x_{\frac{n&plus;1}{2}}"> of ordered data points <img src="https://latex.codecogs.com/svg.image?\left[x_{1}\leq&space;x_{2}...\leq&space;x_{n-1}\leq&space;x_{n}\right]" title="https://latex.codecogs.com/svg.image?\left[x_{1}\leq&space;x_{2}...\leq&space;x_{n-1}\leq&space;x_{n}\right]"> for an odd number of samples or the average of the two centermost points <img src="https://latex.codecogs.com/svg.image?\frac{x_{n/2}&plus;x_{n/2&plus;1}}{2}" title="https://latex.codecogs.com/svg.image?\frac{x_{n/2}&plus;x_{n/2&plus;1}}{2}"> for an even number of samples. | variable | -- |
| Q.US1.006 | <a name="CoV"></a> Coefficient of variation (sample) | -- | CV | The standard deviation (sample) _s_ of a given data set divided by the mean value (sample) <img src="https://latex.codecogs.com/svg.image?\bar{x}" title="https://latex.codecogs.com/svg.image?\bar{x}" /> same dataset (only applicable to ratio scaled variables), calculated as <img src="https://latex.codecogs.com/svg.image?CV=\frac{s}{\bar{x}}" title="https://latex.codecogs.com/svg.image?CV=\frac{s}{\bar{x}}"> | variable | -- |
| Q.US1.007 | <a name="Avg"></a> Mean (population) | -- | -- | -- | -- | -- |
| Q.US1.008 | -- | -- | -- | -- | -- | -- |
| Q.US1.009 | -- | -- | -- | -- | -- | -- |
| Q.US1.010 | -- | -- | -- | -- | -- | -- |
| Q.US1.011 | -- | -- | -- | -- | -- | -- |
