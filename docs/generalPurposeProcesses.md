...
| Code | OSIPI name| Alternative names|Notation|Description|Reference|
| -- | -- | -- | -- | -- | -- |
| G.SE2.001 | <a name="Freehand_Threshold"></a> Freehand | -- | -- | Manual freehand drawing of contours. <br/> **Input:** <br />  [Data (Q.GE1.002)](quantities.md#Data) <br /> **Output**: <br /> [Binary mask (Q.SE1.001)](quantities.md#BinMask) | --|
